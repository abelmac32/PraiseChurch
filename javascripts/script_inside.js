...
function initialize() {
            ...
            var companyImage = new google.maps.MarkerImage('images/marker_logo.png',
                new google.maps.Size(80,53),<!-- Width and height of the marker -->
...
//VISION - SCRIPT
//=======================
	$('.vision-index-details-default').show();
	$('.vision-index').click(function(){
		var visionID = $(this).attr('id');
		$('.vision-index').find('h3').removeClass('opacity-full');
		$('.vision-index-details').removeClass('opacity-full');
		$(this).find('h3').addClass('opacity-full');
		$('#'+visionID+'-details').addClass('opacity-full');
	})
	...
	$('.vision-index').click(function(){
		var visionID = $(this).attr('id');
		$('.vision-index').find('h3').removeClass('opacity-full');
		$('.vision-index-mobile').removeClass('opacity-full');
		$(this).find('h3').addClass('opacity-full');
		$('#'+visionID+'-mobile').addClass('opacity-full');
	})
...
//=======================
    ...
    $('.beneath-intro').waypoint(function (event, direction) {
        if (direction === 'down') {
            ...
            $('#scroll')({bottom: '-150px'}, 700);
        } else {
            $('#scroll')({bottom: '0px'}, 700);
